...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "venv\Scripts\Activate.ps1; Write-Host 'Installing backend dependencies...'; pip install -r api/requirements.txt; python api/app.py"
Write-Host ""
